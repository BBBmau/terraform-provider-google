...
func (r *GoogleServiceAccountListResource) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListServiceAccounts(r.Client, func(rd *schema.ResourceData) error {
...
func ListServiceAccounts(config *transport_tpg.Config, callback func(rd *schema.ResourceData) error) error {

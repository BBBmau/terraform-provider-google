...
func TestAccNetworkConnectivityPolicyBasedRouteListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_network_connectivity_policy_based_route.default",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccNetworkConnectivityPolicyBasedRoute_networkConnectivityPolicyBasedRouteBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_network_connectivity_policy_based_route.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_network_connectivity_policy_based_route.list_query",
...
func testAccNetworkConnectivityPolicyBasedRoute_networkConnectivityPolicyBasedRouteBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_network_connectivity_policy_based_route" "list_query" {
    provider = google
	limit = 10000
    config {
    }

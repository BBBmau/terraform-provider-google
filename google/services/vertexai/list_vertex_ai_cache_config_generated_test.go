...
func TestAccVertexAICacheConfigListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_vertex_ai_cache_config.cache_config",
						[]string{
							"name",
							"project",
						},
			...
			{
				Query:           true,
				Config:          testAccVertexAICacheConfig_vertexAiCacheConfigExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_vertex_ai_cache_config.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_vertex_ai_cache_config.list_query",
...
func testAccVertexAICacheConfig_vertexAiCacheConfigExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_vertex_ai_cache_config" "list_query" {
    provider = google
	limit = 10000
    config {
    }

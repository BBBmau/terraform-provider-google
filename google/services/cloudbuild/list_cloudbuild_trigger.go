	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListCloudBuildTriggers(
			...
			func(rd *schema.ResourceData) error {
				...
				if err := listR.SetResult(ctx, listReq.IncludeResource, &result, rd, "trigger_id"); err != nil {
					return err
				}
...
func ListCloudBuildTriggers(config *transport_tpg.Config,
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Flattener: func(res map[string]interface{}, d *schema.ResourceData, config *transport_tpg.Config) error {
			...
			if err := ResourceCloudBuildTriggerFlatten(d, nil, res, config, project, userAgent, billingProject, url, headers); err != nil {
				return err
			}

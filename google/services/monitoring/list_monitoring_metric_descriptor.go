...
func init() {
	registry.FrameworkListResource{
		...
		Func:        NewMonitoringMetricDescriptorListResource,
	}.Register()
}

var _ list.ListResource = &MonitoringMetricDescriptorListResource{}

type MonitoringMetricDescriptorListResource struct {
	tpgresource.ListResourceMetadata
}

func NewMonitoringMetricDescriptorListResource() list.ListResource {
	listR := &MonitoringMetricDescriptorListResource{}
	listR.TypeName = "google_monitoring_metric_descriptor"
	listR.SDKv2Resource = ResourceMonitoringMetricDescriptor()
...
// MonitoringMetricDescriptorListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type MonitoringMetricDescriptorListModel struct {
	Project types.String `tfsdk:"project"`
}

func (listR *MonitoringMetricDescriptorListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data MonitoringMetricDescriptorListModel
	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListMonitoringMetricDescriptors(
			listR.Client,
			project,
...
func ListMonitoringMetricDescriptors(config *transport_tpg.Config,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceMonitoringMetricDescriptor().Data(&terraform.InstanceState{})
	if project != "" {
	...
	url, err := tpgresource.ReplaceVars(resourceData, config, "{{MonitoringBasePath}}v3/projects/{{project}}/metricDescriptors")
	if err != nil {
		return err
	}
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceMonitoringMetricDescriptor(),
		ListURL:        url,
		BillingProject: billingProject,
		UserAgent:      userAgent,
		ItemName:       "metricDescriptors",
		Flattener: func(res map[string]interface{}, d *schema.ResourceData, config *transport_tpg.Config) error {
			...
			if err = ResourceMonitoringMetricDescriptorFlatten(d, config, res, config, project, userAgent, billingProject, url, headers); err != nil {
				return err
			}

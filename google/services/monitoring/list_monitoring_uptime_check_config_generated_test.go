...
func TestAccMonitoringUptimeCheckConfigListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccMonitoringUptimeCheckConfig_uptimeCheckConfigHttpExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_monitoring_uptime_check_config.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_monitoring_uptime_check_config.list_query",
...
func testAccMonitoringUptimeCheckConfig_uptimeCheckConfigHttpExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_monitoring_uptime_check_config" "list_query" {
    provider = google
	limit = 10000
    config {
    }

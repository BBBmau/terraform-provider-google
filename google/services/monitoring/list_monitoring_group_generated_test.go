...
func TestAccMonitoringGroupListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccMonitoringGroup_monitoringGroupBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_monitoring_group.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_monitoring_group.list_query",
...
func testAccMonitoringGroup_monitoringGroupBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_monitoring_group" "list_query" {
    provider = google
	limit = 10000
    config {
    }

...
func TestAccMonitoringMetricDescriptorListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_monitoring_metric_descriptor.basic",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccMonitoringMetricDescriptor_monitoringMetricDescriptorBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_monitoring_metric_descriptor.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_monitoring_metric_descriptor.list_query",
...
func testAccMonitoringMetricDescriptor_monitoringMetricDescriptorBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_monitoring_metric_descriptor" "list_query" {
    provider = google
	limit = 10000
    config {
    }

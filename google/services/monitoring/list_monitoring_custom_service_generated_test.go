...
func TestAccMonitoringServiceListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccMonitoringService_monitoringServiceCustomExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_monitoring_custom_service.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_monitoring_custom_service.list_query",
...
func testAccMonitoringService_monitoringServiceCustomExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_monitoring_custom_service" "list_query" {
    provider = google
	limit = 10000
    config {
    }

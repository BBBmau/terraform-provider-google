...
func TestAccApigeeControlPlaneAccessListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_apigee_control_plane_access.apigee_control_plane_access",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccApigeeControlPlaneAccess_apigeeControlPlaneAccessBasicTestExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_apigee_control_plane_access.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_apigee_control_plane_access.list_query",
...
func testAccApigeeControlPlaneAccess_apigeeControlPlaneAccessBasicTestExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_apigee_control_plane_access" "list_query" {
    provider = google
	limit = 10000
    config {
    }

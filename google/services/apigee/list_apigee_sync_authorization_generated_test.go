...
func TestAccApigeeSyncAuthorizationListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_apigee_sync_authorization.apigee_sync_authorization",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccApigeeSyncAuthorization_apigeeSyncAuthorizationBasicTestExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_apigee_sync_authorization.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_apigee_sync_authorization.list_query",
...
func testAccApigeeSyncAuthorization_apigeeSyncAuthorizationBasicTestExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_apigee_sync_authorization" "list_query" {
    provider = google
	limit = 10000
    config {
    }

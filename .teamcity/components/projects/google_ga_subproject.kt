...
fun googleSubProjectGa(allConfig: AllContextParameters): Project {
    ...
    return Project{
        ...
        subProject(nightlyTests(gaId, ProviderNameGa, HashiCorpVCSRootGaNightly, gaConfig, NightlyTriggerConfiguration(nightlyTestsEnabled = false, startHour = 17, startMinute = 34)))

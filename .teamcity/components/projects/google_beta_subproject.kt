...
fun googleSubProjectBeta(allConfig: AllContextParameters): Project {
    ...
    return Project{
        ...
        subProject(nightlyTests(betaId, ProviderNameBeta, HashiCorpVCSRootBetaNightly, betaConfig, NightlyTriggerConfiguration(nightlyTestsEnabled = false, startHour = 17, startMinute = 34)))

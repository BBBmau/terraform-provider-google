...
fun globalSweepersSubProject(allConfig: AllContextParameters): Project {
    ...
    // The global sweepers depend on these builds so they only run after all nightly tests complete
    ...
    serviceSweeperConfig.addTrigger(NightlyTriggerConfiguration(startHour=14, startMinute=17, timezone="America/Los_Angeles"))
    ...
    folderSweeperConfig.addTrigger(NightlyTriggerConfiguration(startHour=14, startMinute=17, timezone="America/Los_Angeles"))
